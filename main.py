...
def domain_scanner(sub_domnames):
    ...
    print(Fore.BLUE + '------------------URL after scanning subdomains------------------------')
    ...
    for subdomain in sub_domnames:
        ...
        try:
            ...
            # checking which line of wordlist is processing using the keyword w

            if keyboard.is_pressed('w'):
                system("cat test.txt | grep" + subdomain + " --line-number")
        ...
        # if url is invalid then pass it
            ...
            print(Fore.BLUE + '-----Scanner Stopped-----')
